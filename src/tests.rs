...
mod tests {
    ...
    fn open_vault() {
        ...
        let open_vault_instruction = Instruction::new_with_bytes(
            program_id,
            &[&[bump].as_ref(), winternitz_pubkey_hash.as_ref()].concat(),
            vec![
        ...
        let result: mollusk_svm::result::InstructionResult = mollusk.process_instruction(
            ...
            &vec![
                (payer,AccountSharedData::new(100_000_000u64, 0, &Pubkey::default())),
    ...
    fn close_vault() {
        ...
        let result: mollusk_svm::result::InstructionResult = mollusk.process_instruction(
            ...
            &vec![
                ...
                (
                    to,
                    AccountSharedData::new(900_000_000u64, 0, &program_id),
                ),
            ],
        );
